...
}: Partial<PotTimingsValidationInputs>) => application_start_ms < application_end_ms;

export const isPotPublicRoundStartBeforeEnd = ({
  public_round_start_ms = 0,
  public_round_end_ms = 0,
}: Partial<PotTimingsValidationInputs>) => public_round_start_ms < public_round_end_ms;

...
const PayoutsTab = () => {
  ...
  return (
    <div className="mb-16 flex w-full flex-row items-start gap-6">
          ...
          {!filteredPayouts ? (
            ...
            filteredPayouts.map((payout, index) => {
              ...
              const totalAmount = donationsForProject
                .reduce((previous, donation) => previous + yoctoNearToFloat(donation.net_amount), 0)
                .toFixed(2);

              return (
                <Row key={index}>
                  <RowItem className="project">
                    <AccountProfilePicture accountId={project_id} className="h-[24px] w-[24px]" />

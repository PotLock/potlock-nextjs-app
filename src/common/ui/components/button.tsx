...
import styles from "@/app/_layout/button.module.scss";
...
const buttonVariants = cva(`${styles.button}`, {
  variants: {
    variant: {
      // Brand
      "brand-filled": `${styles.brand} ${styles.filled}`,
      "brand-tonal": `${styles.brand} ${styles.tonal}`,
      "brand-plain": `${styles.brand} ${styles.plain}`,
      "brand-outline": `${styles.brand} ${styles.outline}`,
      // Standard
      "standard-filled": `${styles.standard} ${styles.filled}`,
      "standard-outline": `${styles.standard} ${styles.outline}`,
      "standard-plain": `${styles.standard} ${styles.plain}`,
    },
    size: {
      default: "px-4 py-[9px]",
      icon: "h-10 w-10",

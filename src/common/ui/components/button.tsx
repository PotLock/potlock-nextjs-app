...
const buttonVariants = cva(
  "flex text-sm leading-[157%] items-center justify-center text-[#292929] gap-2 font-medium no-underline cursor-pointer transition-all duration-200 ease-in-out w-fit rounded-lg border-none focus:shadow-button-focus",
  {
    variants: {
      variant: {
        // Brand

...
import type { V1ListsRetrieve2QueryResponse, V1ListsRetrieve2PathParams, V1ListsRetrieve2404, V1ListsRetrieve2500 } from "../types/V1ListsRetrieve2";

 type V1ListsRetrieve2Client = typeof client<V1ListsRetrieve2QueryResponse, V1ListsRetrieve2404 | V1ListsRetrieve2500, never>;
...
export function v1ListsRetrieve2QueryOptions<TData = V1ListsRetrieve2["response"]>(listId: V1ListsRetrieve2PathParams["list_id"], options: V1ListsRetrieve2["client"]["parameters"] = {}): SWRConfiguration<TData, V1ListsRetrieve2["error"]> {
    return {
        fetcher: async () => {
 ...
 */
export function useV1ListsRetrieve2<TData = V1ListsRetrieve2["response"]>(listId: V1ListsRetrieve2PathParams["list_id"], options?: {
    ...
    const query = useSWR<TData, V1ListsRetrieve2["error"], typeof url | null>(shouldFetch ? url : null, {

...
type V1PotsRetrieveClient = typeof client<
...
export function v1PotsRetrieveQueryOptions<TData = V1PotsRetrieve["response"]>(
  options: V1PotsRetrieve["client"]["parameters"] = {},
): SWRConfiguration<TData, V1PotsRetrieve["error"]> {
  return {
    fetcher: async () => {
 ...
 * @link /api/v1/pots
 */
export function useV1PotsRetrieve<
  TData = V1PotsRetrieve["response"],
>(options?: {
  ...
  const query = useSWR<TData, V1PotsRetrieve["error"], typeof url | null>(

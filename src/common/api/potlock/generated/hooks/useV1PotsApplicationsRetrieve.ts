...
export function v1PotsApplicationsRetrieveQueryOptions<
  TData = V1PotsApplicationsRetrieve["response"],
>(
  potId: V1PotsApplicationsRetrievePathParams["pot_id"],
  options: V1PotsApplicationsRetrieve["client"]["parameters"] = {},
): SWRConfiguration<TData, V1PotsApplicationsRetrieve["error"]> {
  return {
    fetcher: async () => {
 ...
 */
export function useV1PotsApplicationsRetrieve<
  TData = V1PotsApplicationsRetrieve["response"],
>(
  potId: V1PotsApplicationsRetrievePathParams["pot_id"],
  options?: {
  ...
  const query = useSWR<
    TData,
    V1PotsApplicationsRetrieve["error"],
    typeof url | null

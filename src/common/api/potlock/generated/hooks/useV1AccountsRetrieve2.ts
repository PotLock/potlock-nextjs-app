...
import type { V1AccountsRetrieve2QueryResponse, V1AccountsRetrieve2PathParams, V1AccountsRetrieve2404, V1AccountsRetrieve2500 } from "../types/V1AccountsRetrieve2";

 type V1AccountsRetrieve2Client = typeof client<V1AccountsRetrieve2QueryResponse, V1AccountsRetrieve2404 | V1AccountsRetrieve2500, never>;
...
export function v1AccountsRetrieve2QueryOptions<TData = V1AccountsRetrieve2["response"]>(accountId: V1AccountsRetrieve2PathParams["account_id"], options: V1AccountsRetrieve2["client"]["parameters"] = {}): SWRConfiguration<TData, V1AccountsRetrieve2["error"]> {
    return {
        fetcher: async () => {
 ...
 */
export function useV1AccountsRetrieve2<TData = V1AccountsRetrieve2["response"]>(accountId: V1AccountsRetrieve2PathParams["account_id"], options?: {
    ...
    const query = useSWR<TData, V1AccountsRetrieve2["error"], typeof url | null>(shouldFetch ? url : null, {

...
export function v1PotsPayoutsRetrieveQueryOptions<
  TData = V1PotsPayoutsRetrieve["response"],
>(
  potId: V1PotsPayoutsRetrievePathParams["pot_id"],
  options: V1PotsPayoutsRetrieve["client"]["parameters"] = {},
): SWRConfiguration<TData, V1PotsPayoutsRetrieve["error"]> {
  return {
    fetcher: async () => {
 ...
 */
export function useV1PotsPayoutsRetrieve<
  TData = V1PotsPayoutsRetrieve["response"],
>(
  potId: V1PotsPayoutsRetrievePathParams["pot_id"],
  options?: {

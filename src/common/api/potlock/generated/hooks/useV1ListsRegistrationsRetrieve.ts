...
import type { V1ListsRegistrationsRetrieveQueryResponse, V1ListsRegistrationsRetrievePathParams, V1ListsRegistrationsRetrieve404, V1ListsRegistrationsRetrieve500 } from "../types/V1ListsRegistrationsRetrieve";

 type V1ListsRegistrationsRetrieveClient = typeof client<V1ListsRegistrationsRetrieveQueryResponse, V1ListsRegistrationsRetrieve404 | V1ListsRegistrationsRetrieve500, never>;
...
export function v1ListsRegistrationsRetrieveQueryOptions<TData = V1ListsRegistrationsRetrieve["response"]>(listId: V1ListsRegistrationsRetrievePathParams["list_id"], options: V1ListsRegistrationsRetrieve["client"]["parameters"] = {}): SWRConfiguration<TData, V1ListsRegistrationsRetrieve["error"]> {
    return {
        fetcher: async () => {
 ...
 */
export function useV1ListsRegistrationsRetrieve<TData = V1ListsRegistrationsRetrieve["response"]>(listId: V1ListsRegistrationsRetrievePathParams["list_id"], options?: {
    ...
    const query = useSWR<TData, V1ListsRegistrationsRetrieve["error"], typeof url | null>(shouldFetch ? url : null, {

...
import type { V1PotsRetrieve2QueryResponse, V1PotsRetrieve2PathParams, V1PotsRetrieve2404 } from "../types/V1PotsRetrieve2";

 type V1PotsRetrieve2Client = typeof client<V1PotsRetrieve2QueryResponse, V1PotsRetrieve2404, never>;
...
export function v1PotsRetrieve2QueryOptions<TData = V1PotsRetrieve2["response"]>(potId: V1PotsRetrieve2PathParams["pot_id"], options: V1PotsRetrieve2["client"]["parameters"] = {}): SWRConfiguration<TData, V1PotsRetrieve2["error"]> {
    return {
        fetcher: async () => {
 ...
 */
export function useV1PotsRetrieve2<TData = V1PotsRetrieve2["response"]>(potId: V1PotsRetrieve2PathParams["pot_id"], options?: {
    ...
    const query = useSWR<TData, V1PotsRetrieve2["error"], typeof url | null>(shouldFetch ? url : null, {

...
import type { V1PotsSponsorsRetrieveQueryResponse, V1PotsSponsorsRetrievePathParams, V1PotsSponsorsRetrieve404 } from "../types/V1PotsSponsorsRetrieve";

 type V1PotsSponsorsRetrieveClient = typeof client<V1PotsSponsorsRetrieveQueryResponse, V1PotsSponsorsRetrieve404, never>;
...
export function v1PotsSponsorsRetrieveQueryOptions<TData = V1PotsSponsorsRetrieve["response"]>(potId: V1PotsSponsorsRetrievePathParams["pot_id"], options: V1PotsSponsorsRetrieve["client"]["parameters"] = {}): SWRConfiguration<TData, V1PotsSponsorsRetrieve["error"]> {
    return {
        fetcher: async () => {
 ...
 */
export function useV1PotsSponsorsRetrieve<TData = V1PotsSponsorsRetrieve["response"]>(potId: V1PotsSponsorsRetrievePathParams["pot_id"], options?: {
    ...
    const query = useSWR<TData, V1PotsSponsorsRetrieve["error"], typeof url | null>(shouldFetch ? url : null, {

...
import type { V1PotsDonationsRetrieveQueryResponse, V1PotsDonationsRetrievePathParams, V1PotsDonationsRetrieve404 } from "../types/V1PotsDonationsRetrieve";

 type V1PotsDonationsRetrieveClient = typeof client<V1PotsDonationsRetrieveQueryResponse, V1PotsDonationsRetrieve404, never>;
...
export function v1PotsDonationsRetrieveQueryOptions<TData = V1PotsDonationsRetrieve["response"]>(potId: V1PotsDonationsRetrievePathParams["pot_id"], options: V1PotsDonationsRetrieve["client"]["parameters"] = {}): SWRConfiguration<TData, V1PotsDonationsRetrieve["error"]> {
    return {
        fetcher: async () => {
 ...
 */
export function useV1PotsDonationsRetrieve<TData = V1PotsDonationsRetrieve["response"]>(potId: V1PotsDonationsRetrievePathParams["pot_id"], options?: {
    ...
    const query = useSWR<TData, V1PotsDonationsRetrieve["error"], typeof url | null>(shouldFetch ? url : null, {

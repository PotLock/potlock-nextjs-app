...
import type { V1DonorsRetrieveQueryResponse, V1DonorsRetrieveQueryParams, V1DonorsRetrieve500 } from "../types/V1DonorsRetrieve";

 type V1DonorsRetrieveClient = typeof client<V1DonorsRetrieveQueryResponse, V1DonorsRetrieve500, never>;
...
export function v1DonorsRetrieveQueryOptions<TData = V1DonorsRetrieve["response"]>(params?: V1DonorsRetrieve["queryParams"], options: V1DonorsRetrieve["client"]["parameters"] = {}): SWRConfiguration<TData, V1DonorsRetrieve["error"]> {
    return {
        fetcher: async () => {
 ...
 * @link /api/v1/donors
 */
export function useV1DonorsRetrieve<TData = V1DonorsRetrieve["response"]>(params?: V1DonorsRetrieve["queryParams"], options?: {
    ...
    const query = useSWR<TData, V1DonorsRetrieve["error"], [
        typeof url,
        typeof params

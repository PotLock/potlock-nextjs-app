...
export const v1AccountsPayoutsReceivedRetrieve = (
    ...
    return axios.get(
      `/api/v1/accounts/${accountId}/payouts_received`,options
    );
  }



export const getV1AccountsPayoutsReceivedRetrieveKey = (accountId: string,) => [`/api/v1/accounts/${accountId}/payouts_received`] as const;


export type V1AccountsPayoutsReceivedRetrieveQueryResult = NonNullable<Awaited<ReturnType<typeof v1AccountsPayoutsReceivedRetrieve>>>
...
export const useV1AccountsPayoutsReceivedRetrieve = <TError = AxiosError<void>>(
  accountId: string, options?: { swr?:SWRConfiguration<Awaited<ReturnType<typeof v1AccountsPayoutsReceivedRetrieve>>, TError> & { swrKey?: Key, enabled?: boolean }, axios?: AxiosRequestConfig }
) => {
  const {swr: swrOptions, axios: axiosOptions} = options ?? {}

  const isEnabled = swrOptions?.enabled !== false && !!(accountId)
  const swrKey = swrOptions?.swrKey ?? (() => isEnabled ? getV1AccountsPayoutsReceivedRetrieveKey(accountId) : null);
  const swrFn = () => v1AccountsPayoutsReceivedRetrieve(accountId, axiosOptions);
...
export const v1AccountsPotApplicationsRetrieve = (
    accountId: string,
    params?: V1AccountsPotApplicationsRetrieveParams, options?: AxiosRequestConfig
...
export const getV1AccountsPotApplicationsRetrieveKey = (accountId: string,
    params?: V1AccountsPotApplicationsRetrieveParams,) => [`/api/v1/accounts/${accountId}/pot_applications`, ...(params ? [params]: [])] as const;
...
export const useV1AccountsPotApplicationsRetrieve = <TError = AxiosError<void>>(
  accountId: string,
    params?: V1AccountsPotApplicationsRetrieveParams, options?: { swr?:SWRConfiguration<Awaited<ReturnType<typeof v1AccountsPotApplicationsRetrieve>>, TError> & { swrKey?: Key, enabled?: boolean }, axios?: AxiosRequestConfig }
) => {
  const {swr: swrOptions, axios: axiosOptions} = options ?? {}

  const isEnabled = swrOptions?.enabled !== false && !!(accountId)
  const swrKey = swrOptions?.swrKey ?? (() => isEnabled ? getV1AccountsPotApplicationsRetrieveKey(accountId,params) : null);
...
export const v1DonateContractConfigRetrieve = (
    ...
    return axios.get(
      `/api/v1/donate_contract_config`,options
    );
  }



export const getV1DonateContractConfigRetrieveKey = () => [`/api/v1/donate_contract_config`] as const;


export type V1DonateContractConfigRetrieveQueryResult = NonNullable<Awaited<ReturnType<typeof v1DonateContractConfigRetrieve>>>
...
export const useV1DonateContractConfigRetrieve = <TError = AxiosError<void>>(
   options?: { swr?:SWRConfiguration<Awaited<ReturnType<typeof v1DonateContractConfigRetrieve>>, TError> & { swrKey?: Key, enabled?: boolean }, axios?: AxiosRequestConfig }
) => {
  const {swr: swrOptions, axios: axiosOptions} = options ?? {}

  const isEnabled = swrOptions?.enabled !== false
  const swrKey = swrOptions?.swrKey ?? (() => isEnabled ? getV1DonateContractConfigRetrieveKey() : null);
...
export const v1ListsRandomRegistrationRetrieve = (
    listId: number,
    params?: V1ListsRandomRegistrationRetrieveParams, options?: AxiosRequestConfig
...
export const getV1ListsRandomRegistrationRetrieveKey = (listId: number,
    params?: V1ListsRandomRegistrationRetrieveParams,) => [`/api/v1/lists/${listId}/random_registration`, ...(params ? [params]: [])] as const;


export type V1ListsRandomRegistrationRetrieveQueryResult = NonNullable<Awaited<ReturnType<typeof v1ListsRandomRegistrationRetrieve>>>
...
export const useV1ListsRandomRegistrationRetrieve = <TError = AxiosError<void>>(
  listId: number,
    params?: V1ListsRandomRegistrationRetrieveParams, options?: { swr?:SWRConfiguration<Awaited<ReturnType<typeof v1ListsRandomRegistrationRetrieve>>, TError> & { swrKey?: Key, enabled?: boolean }, axios?: AxiosRequestConfig }
) => {
  const {swr: swrOptions, axios: axiosOptions} = options ?? {}

  const isEnabled = swrOptions?.enabled !== false && !!(listId)
  const swrKey = swrOptions?.swrKey ?? (() => isEnabled ? getV1ListsRandomRegistrationRetrieveKey(listId,params) : null);

...
export const Nav = () => {
  ...
  return (
    <>
      <nav className="max-sm:px-1 md:h-[96px] 2xl-container z-50 mx-auto flex w-full content-between items-center justify-between self-stretch bg-transparent px-[40px] pb-6 pt-6">
        {/* Left */}
        <div className="flex">
